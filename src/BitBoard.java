//Adapted from the state.java (Real bitboard still WIP)
//Basic bitboard that stores the state of the board.
...
public class BitBoard {
	...
	public static void initMove(int[][][] moves){
		BitBoard.moves = moves;
	}
	

	public BitBoard(int[][] field, int[] top) {
